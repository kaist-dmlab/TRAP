...
class Config(object):
    def __init__(self, config_file):
        ...
        try:
            ...
            print
            "loading config: %s failed" % (config_file)
        self.train_graph_file = conf.get("Graph_Data", "train_graph_file")
        self.N = conf.getint("Graph_Data", "N")
        ...
        self.using_trap = conf.getfloat("Model_Setup", "using_trap")
        ...
        self.lam = conf.getfloat("Model_Setup", "lam")
